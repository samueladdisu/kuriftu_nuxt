    ...
    <div class="destination-links">
      <div class="container">
       ...
       <ul class="link-destination">
            ...
            <li><nuxt-link  class="a-link  active"  to="afarexperience">Experiences   <hr class="activeline"></nuxt-link ></li>
            <li><nuxt-link  class="a-link "  to="afarwellness">Wellness</nuxt-link ></li>
      ...
      <div class="see-more">
        ...
        <div class="all-cards">
          <div class="single-card" data-aos="fade-up"  data-aos-duration="3000">
            <img src="../../assets/image/afar.jpg" alt="">
            <h3>Eastern Route Tours</h3>
            <p>Our resort arranges sightseeing tours so you can relax and enjoy the colorful sulphur springs of Danakil Depression, hot springs of Dallol and active volcano in Erta ale.</p>
