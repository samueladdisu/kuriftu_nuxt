      ...
      <div class="container">
        <div class="wrapper">
          <ul class="link-destination">
            ...
            <li><nuxt-link  class="a-link active" to="entotoaccommodation"> <p>Accomodation</p>  <hr class="activeline"> </nuxt-link > </li>
...
<div class="accomondation-room">
  <div class="single-accomondation">
    <img src="../../assets/image/tent2.jpg" alt="">
    <div class="room-name">
      <h4>Tent</h4>
    </div>
    <div class="room-desc">
    ...
    <div class="single-accomondation">
    <img src="../../assets/image/tent.jpg" alt="">
    <div class="room-name">
      <h4>Tent</h4>
    </div>
    <div class="room-desc">
