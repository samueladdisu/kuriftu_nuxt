      ...
      <div class="container">
        <div class="wrapper">
          <ul class="link-destination">
            ...
            <li><nuxt-link  class="a-link "  to="waterparkexperience">Experiences</nuxt-link ></li>
       
                <li><nuxt-link  class="a-link active"  to="waterparkdining">Dining <hr class="activeline"
              /></nuxt-link ></li>
...
<div class="container">
   <div class="main-title">
            <h2>Dining</h2>
            <p>
          Explore the vast dining possibilities of our restaurants.
            </p>
          </div>
          <Waterparkslide />
