      ...
      <div class="container">
        <div class="wrapper">
          <ul class="link-destination">
            ...
            <li>
              <nuxt-link class="a-link" to="waterparkexperience"
            ...
            <li>
              <nuxt-link class="a-link active" to="waterparkevent"
                >Celebration & Events
                <hr class="activeline"
              /></nuxt-link>
            </li>
             <li>
              <nuxt-link class="a-link" to="waterparkgallery">Gallery </nuxt-link>
            </li>
            <li>
    ...
    <section class="top-gallery">
      <div class="container">
        <div class="main-title">
          ...
          <p>
    From black suites to grand ballrooms, we have the ideal venue for any event.
          </p>
        </div>

        <div class="image-wrapper">
          <div class="content single-image" data-aos="zoom-in">
