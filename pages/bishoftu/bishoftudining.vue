      ...
      <div class="container">
        <div class="wrapper">
          <ul class="link-destination">
            ...
            <li>
              <nuxt-link  class="a-link " to="bishoftuaccommodation"> <p>Accomodation</p> </nuxt-link > 
            </li>
           
            <li><nuxt-link  class="a-link "  to="bishoftuexperience">Experiences</nuxt-link ></li>
            <li><nuxt-link  class="a-link  "  to="bishoftuwellness">Wellness </nuxt-link></li>
                <li><nuxt-link  class="a-link active"  to="bishoftudining">Dining <hr class="activeline"
              /></nuxt-link ></li>
