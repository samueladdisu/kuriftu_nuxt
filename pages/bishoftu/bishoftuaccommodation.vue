      ...
      <div class="container">
        <div class="wrapper">
          <ul class="link-destination">
            ...
            <li><nuxt-link  class="a-link active" to="bishoftuaccommodation"> <p>Accomodation</p>  <hr class="activeline"> </nuxt-link > </li>
...
<div class="container">
   <div class="main-title">
            ...
            <p>
             Bishoftu is home to 7 crater lakes and is a renowed resort town which serves as an amazing getaway from the hustle and bustle of the city life.
            </p>
          </div>
          <Bishoftuslide />
