     ...
     <ul class="link-destination">
            ...
            <li>
              <nuxt-link  class="a-link " to="tanaevent">Celebration & Events</nuxt-link >
                ...
                <li><nuxt-link  class="a-link active"   to="tanagallery">Gallery <hr class="activeline"
              /></nuxt-link ></li>
            <li>
      ...
      <div class="container">
        <div class="popup-wrapper">
          <div class="close">
            ...
            <div class="close-btn">
              <img src="../../assets/image/Icons/close-btn.svg" alt="" />
            </div>
          </div>
          <div class="image">
            <img src="../../assets/image/SAM09856-min.jpg" alt="" />
          ...
          <div class="next">
            <div class="dest-title">
              <p>ENTOTO EXPERIENCE</p>
            </div>
            <div class="next-btn">
              <img src="../../assets/image/Icons/popback.svg" alt="" />
              <img src="../../assets/image/Icons/popnext.svg" alt="" />
            </div>
          </div>
        </div>
      </div>
  ...
  .image-popup {
    ...
    .container {
      .popup-wrapper {
        ...
        box-shadow: 10px 10px 15px rgba(194, 135, 74, 0.1);
        @include responsive($md) {
          padding: 2rem;
        }
